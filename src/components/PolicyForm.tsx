...
const PolicyForm: React.FC = () => {
  ...
  const handleGeneratePolicy = () => {
    console.log('Generating policy with data:', {
      businessName,
      policyType,
      businessDescription,
    });
    ...
    <div className="container mx-auto p-4 max-w-2xl bg-white shadow-md rounded-lg mt-10">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="grid gap-2">
          ...
          <Select onValueChange={setPolicyType}>
      ...
      <div className="grid gap-2 mt-6">
        ...
        <Textarea
          ...
          placeholder="Describe your business and its activities..."
          rows={6}
          className="border-gray-300 focus:border-blue-500 focus:ring-blue-500"
      ...
      <div className="mt-8 text-center">
        <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-md" onClick={handleGeneratePolicy}>
          Generate Policy
        </Button>
      </div>
    </div>
